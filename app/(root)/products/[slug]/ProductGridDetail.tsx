...
// const ProductGridDetail = ({products}: Props) => {
//   return (
...
//             <p className="text-center text-sm text-gray-400">({product.variants[0].stock_quantity})</p>
//             <h2 className="text-2xl font-bold">
//               {product.name}
//             </h2>

//             <p className="text-3xl font-semibold mt-2">Rs. {product.base_price}</p>
...
//                 <FreeAdvertizemantCard text="Free shipping" bgColor="#f4fcf4" color="success" />
//               )}
//               {product.free_gift && (
...
//               <p className="">
//                 {" "}
//                 <span className="text-black font-bold">SKU:</span> {product.variants[0].sku}
//               </p>
//               <p>
