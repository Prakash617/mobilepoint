      ...
      <div className="container flex flex-col lg:flex-row lg:space-x-10 space-y-10 lg:space-y-0">
        ...
        <div className="w-full lg:w-1/4 p-1 text-left space-y-8">
          <p className="uppercase font-bold">
            {sidesettingdata?.site_name || "Mobile"}
          </p>

          <div className="uppercase mt-4">
            <p>hotline 24/7</p>
            <p className="text-primary text-xl font-bold">
              {sidesettingdata?.phone || "xxx"}
            </p>
          </div>
          ...
          <div className="flex flex-wrap space-x-4">
            {sidesettingdata?.facebook_url &&
              sidesettingdata.facebook_url !== "xxx" && (
                <Link
            ...
            {sidesettingdata?.twitter_url &&
              sidesettingdata.twitter_url !== "xxx" && (
                <Link
            ...
            {sidesettingdata?.instagram_url &&
              sidesettingdata.instagram_url !== "xxx" && (
                <Link
            ...
            {sidesettingdata?.linkedin_url &&
              sidesettingdata.linkedin_url !== "xxx" && (
                <Link
            ...
            {sidesettingdata?.youtube_url &&
              sidesettingdata.youtube_url !== "xxx" && (
                <Link
      ...
      <div className="container  flex flex-col lg:flex-row gap-10 lg:gap-0 lg:space-x-40">
        ...
        <div className="flex gap-4 ">
          <div>
            {" "}
            <button
              className="flex items-center gap-1 border border-gray-300 rounded-md px-4 py-2
          ...
          <div>
            {" "}
            <button
              className="flex items-center gap-1 border border-gray-300 rounded-md px-2 py-2
                   text-sm font-medium text-gray-700 cursor-pointer
                   hover:border-gray-400 hover:bg-gray-50 transition active:scale-[0.97]"
            >
              <div className="w-5 h-5 rounded-full overflow-hidden flex items-center justify-center">
